...
# drag_n_drop = driver.find_element(By.XPATH, "//a[contains(text(),'Drag and Drop')]")
# static = driver.find_element(By.XPATH, "//a[contains(text(),'Static')]")

# actions = ActionChains(driver)
# actions.move_to_element(interactions).move_to_element(drag_n_drop).move_to_element(static).click().perform()
...
# left = 0
# right = 1
# print(sliders[left].location, sliders[right].location) # left x: 59, right x: 510
# actions = ActionChains(driver)
